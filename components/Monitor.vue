...
<template>
  <header>
    <section class="background d-flex justify-center" :class="(display.height * 1.60 < display.width) ? '' : 'align-end'">
      <v-card :height="h" style="margin-bottom:21%" :width="w" rounded="lg" variant="outlined" class="mt-9 mt-xl-12">
